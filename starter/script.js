...
console.log(25 ** (1 / 2));
console.log(8 ** (1 / 3));
console.log(Math.max(23, 4, 56, 12));
...
const now = new Date();
console.log(now);
console.log(new Date(2022, 6, 2, 21, 10, 78));
console.log(new Date(2022, 6, 32));
const future = new Date(2022, 6, 32);
...
//);
const ingredients = ['olives', 'jalepino'];
